...
namespace WhatIsOvrride
{
    public class Description
    {
        public void OverrideDesc()
        {
             ...
             * 다시 정의(제정의)해서 사용한다는 개념이 메서드 오버라이드라고 한다.
    ...
    public class Child : Parent
    {
        ...
        public override void Walk(int count)         //오버라이딩
        {
            Console.WriteLine("[자식] {0}번 걷다", count);
        }
        public override void Walk(string where_)     //오버라이딩
        {
    ...
    public class Button
    {
        ...
        public virtual void OnClickButton()
        {
            ...
            // 이 버튼을 누르면 퀘스트 창이 열림. (( 이렇게 정의해놓으면 안됌)
        }       //OnClickButton()
    }
