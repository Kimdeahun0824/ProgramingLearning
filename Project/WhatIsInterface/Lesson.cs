...
namespace WhatIsInterface
{
    internal class Lesson
    {
         ...
         *  - 인터페이스는 계약(Contract) 의미가 강하며 속성, 메서, 이벤트, 인덱서 등 
         *      구조를 미리 정의한다.
         */
         ...
         * 
         * 추상 클래스
         *  - 구현된 코드가 들어온다. 즉, 메서드 시그니처만 있는 것이 아니라 사용 가능한 실제로 구현된
         *      메서드도 들어온다.
